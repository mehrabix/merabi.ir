		...
		<div class="flex gap-x-3">
			...
			<a href="https://mehrabi.medium.com/">
				<svg
					...
					xmlns="http://www.w3.org/2000/svg">
					<path
						d="M4.5 4.5L7.5 8.5L10.5 4.5M4.5 4.5H3M4.5 4.5V11M10.5 4.5H12M10.5 4.5V11M3 10.5H6M9
						10.5H12M1.5 0.5H13.5C14.0523 0.5 14.5 0.947715 14.5 1.5V13.5C14.5 14.0523 14.0523 14.5
						13.5 14.5H1.5C0.947716 14.5 0.5 14.0523 0.5 13.5V1.5C0.5 0.947716 0.947715 0.5 1.5 0.5Z" />
				</svg>
			</a>
			...
			<a href="https://t.me/ahmadmehrabix">
				...
				<svg class="fill-white hover:fill-[#000] transition-all duration-300 ease-in-out"  width="35px" height="35px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="currentColor" >
