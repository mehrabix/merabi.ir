...
<div class="flex flex-col mt-9 justify-center gap-9 items-center lg:flex-row px-6">
	...
	<div class="flex flex-col gap-y-3 items-center justify-center text-center">
		<div
			class="text-white leading-snug font-black text-5xl flex flex-wrap gap-x-4 items-center justify-center "
		>
			<p>Hi, I'm</p>
			<h1>Ahmad Mehrabi</h1>
		</div>
		...
		<div class="flex gap-x-3">
            ...
            <a href="https://t.me/ahmadmehrabix">
                <svg class="stroke-white" width="35px" height="35px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M21 5L2 12.5L9 13.5M21 5L18.5 20L9 13.5M21 5L9 13.5M9 13.5V19L12.2488 15.7229"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
